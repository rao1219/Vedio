(function() {
  var PrettyError, aglio, cErr, cWarn, chokidar, clc, fs, getLineNo, http, logError, logWarnings, parser, path, serveStatic;
  ...
  logWarnings = function(warnings) {
    var i, len, lineNo, ref, results, warning;
    ref = warnings || [];
    results = [];
    for (i = 0, len = ref.length; i < len; i++) {
      warning = ref[i];
      lineNo = getLineNo(warnings.input, warning) || 0;
      results.push(console.error(cWarn(">> Line " + lineNo + ":") + (" " + warning.message + " (warning code " + warning.code + ")")));
    }
    return results;
  };
