(function() {
  var Drafter, INCLUDE, LEGACY_TEMPLATES, ROOT, benchmark, errMsg, fs, includeDirective, includeReplace, path,
  ...
  exports.render = function(input, options, done) {
    var drafter, filteredInput, ref, variables;
    ...
    drafter = new Drafter();
    return drafter.make(filteredInput, function(err, res) {
